...
import correctWayId from "../../../assets/images/pages/student/registrationDetails/correct_id.svg"
import wrongWayId from "../../../assets/images/pages/student/registrationDetails/blur_id.svg"
import sideId from "../../../assets/images/pages/student/registrationDetails/side_ide.svg"
import StepConnector, { stepConnectorClasses } from "@mui/material/StepConnector";
import "./style.css";
import Camera from "../camera";
import { authSelector } from "../../../redux/slicers/authSlice";
import { useSelector } from "react-redux";
import { ASSESSMENT_PAGE, STUDENT_BASIC_INFORMATION, STUDENT_DETAILS_PAGE } from "../../../config/constants/routePathConstants/student";
...
export default function FaceCapture() {
  ...
  const NAVIGATE_PATH = `${STUDENT_BASIC_INFORMATION}/${batchId}/${candidateId}/${questionId}`;
    ...
    <div className="face-capture-container hscreen">
      <div className="inner-card-body">
        <Stepper alternativeLabel activeStep={3} connector={<ColorlibConnector />}>
          {STEPS.map((label) => (
            <Step key={label}>
              <StepLabel sx={{ "& .MuiStepLabel-label": { marginTop: "5px !important" } }} StepIconComponent={ColorlibStepIcon}>{label}</StepLabel>
            </Step>
          ))}
        </Stepper>
        ...
        <div className="inner-card">
            ...
            <div className="face-card-body">
              ...
              <div className="image-quality">
                <div className="correct-image">
                  <h4>Correct Way</h4>
                  <img src={correctWayId} alt="correct-way-id" />
                  <p>Face Straight</p>
                </div>
                <div className="wrong-image-side">
                  ...
                  <div className="wrong-image">
                    <div className="wrong-image-box">
                      <img src={wrongWayId} alt="wrong-way-id" />
                      <p>Blurred Image</p>
                    </div>
                    <div className="wrong-image-box">
                      <img src={sideId} alt="side-id-img" />
                      <p>Side Face cut</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="face-card">
            <h2>Capture ID</h2>
            <div className="face-card-body">
              <p>Please center your Aadhaar card in the frame and then press the 'Capture Aadhaar' button.</p>
              <div className="camera-module-wrapper">
              <Camera
                captureBtnText='Capture Aadhar'
                navigatePath={NAVIGATE_PATH}
              />
              </div>
            </div>
          </div>
