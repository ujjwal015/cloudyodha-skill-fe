...
export default function Questions() {
  ...
  if (params?.qId && formValues?.question_bank_id === "") {
    dispatch(
      getParticularQuestionDetailsApi(
        setLoading,
        params?.qId,
        setFormValues,
        params.lang
  ...
  const radioChecked = (e, index) => {
    const { name, value, type, checked } = e.target;
    delete formValues.questions[index].correctAnswer;
    ...
    formValues.questions.map((el, index) => {
      for (let key in el) {
        ...
        if (name === "options") {
          value.map((e, index_c) => {
            if (e.title === "") {
              if (e?.file instanceof File || e?.optionUrl) {
        ...
        .then((dataArray) => {
          ...
          const updatedQuesOptions = optionsCopy.map((el, pos) => {
            ...
            const newDetail = {
              ...
              optionImgKey:
                dataArray?.[pos]?.optionIdKey || el?.optionImgKey || "",
  ...
  const removeImage = (index, index_c) => {
    ...
    delete existingQuestions[index].options[index_c].optionImgKey;
    delete existingQuestions[index].options[index_c].optionUrl;
    setFormValues({ ...formValues, questions: existingQuestions });
                ...
                <div className="content-wrapper">
                  ...
                  <div className="form-group_question">
                    ...
                    <div className="formSwitch_toggle_wrapper">
                      ...
                      <FormSwitch
                        value={
                          formValues.questions[index].options.length === 2
                            ? true
                            : false
                        }
                          ...
                          <div className="option_card">
                            ...
                            <div className="option_content">
                              <Input
                                ...
                                inputProps={{
                                  checked:
                                    formValues?.questions[0]?.answer ==
                                      lowercaseAlphabets[index_c] ||
                                    formValues?.questions[0]?.correctAnswer ==
                                      lowercaseAlphabets[index_c],
                                }}
