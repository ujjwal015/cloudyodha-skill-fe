...
const PieChartComp = () => {
  ...
  useEffect(() => {
    if (Object.entries(dashboardsData).length) {
      setPieChartData(dashboardsData?.AssesorStatics?.AssesorDetails);
    }
  }, [dashboardsData]);
        ...
        <div className="card-lists pie-results">
          <PieChart width={300} height={300}>
            ...
            >
              ...
              <Label
                content={
                  <CustomLabel labelText="Total Assessors" value={dashboardsData?.AssesorStatics?.totalAssesorCount} />
                }
                position="center"
              />
            </Pie>
