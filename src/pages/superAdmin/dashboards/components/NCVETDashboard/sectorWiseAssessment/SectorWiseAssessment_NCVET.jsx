...
const SectorWiseAssessmentDoughnutChart = ({ clientId }) => {
    ...
    return [
      {
        beforeDraw: (chart, args, opts) => {
          ...
          arcs.forEach((a) => {
            ctx.beginPath();
            // Decrease the innerRadius to make the circle smaller
            const smallerInnerRadius = a.innerRadius - 5; // Adjust this value as needed
            ctx.arc(a.x, a.y, smallerInnerRadius, a.startAngle, a.endAngle);
            ctx.stroke();
          });
        },
      },
  ...
  return <SectorWiseDohNut doughNutData={doughNutData} />;
};
