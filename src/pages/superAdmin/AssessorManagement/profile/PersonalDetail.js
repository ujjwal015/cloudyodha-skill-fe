...
// import { createAssessorPersonalDetailsApi } from "../../../../api/superAdminApi/assessorManagement";
...
const initialFormValuesForPMVishvakarma=[
  { cardType: "Pancard", cardNo: "", card: "" }
]
const PersonalDetail = (props) => {
  ...
  const handleformValuesSet=(data)=>{
    return setFormValues([...formValues,...data])
  }

  useEffect(() => {
    if (assessorMDBId) {
      dispatch(getAssessorPersonalDetailsApi(assessorMDBId, handleformValuesSet));
    }
  }, []);
  ...
  return (
    <>
                          ...
                          <>
                            ...
                            <div className="form-group">
                              <Input
                                ...
                                } // Pass the index 0 for AadharCard
                              ...
                              <div className="card_upload__doc">
                                ...
                                <div
                                  ...
                                  style={{
                                    display: [
                                      formValues?.[index].card ? "" : "none",
                                    ],
                                  }}
                                >
                                  <p>
                                    {formValues?.[index].card
                                      ? formValues?.[index].card?.name
                                      : ""}
                                  </p>
                                  <Icon
                                    className="trash__icon"
      ...
      <div
        ...
        // style={{ display: [formValues?.[0]?._id ? "none" : ""] }}
      >
        <Button
