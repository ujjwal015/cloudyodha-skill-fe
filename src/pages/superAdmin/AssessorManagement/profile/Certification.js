...
import {
  ...
  jobrolesDetails as getJobRoleDetails
...
import AutoCompleteAsyncInput from "../../../../components/common/AutoCompleteAsyncInput.js";
...
const Certification = ({ schemeType }) => {
  ...
  const [experienceDetails, setExperienceDetails] = useState(experienceInitialValues());
  const [educationDetails, setEducationDetails] = useState(educationInitialValues());
  const [agreementFormValues, setAgreementFormValues] = useState(agreementInitialValues());
  const [jobRoleFormValues, setJobRoleFormValues] = useState(jobRoleInitialValues());
  ...
  const changeHandler = (e) => {
    ...
    if (activeSection === "exp") setExperienceDetails({ ...experienceDetails, [name]: value });
    else if (activeSection === "edc") setEducationDetails({ ...educationDetails, [name]: value });
    else if (activeSection === "agr") setAgreementFormValues({ ...agreementFormValues, [name]: value });
  ...
  function dateDuration(date1, date2) {
    ...
    const monthsDiff =
      (date2Obj.getFullYear() - date1Obj.getFullYear()) * 12 + date2Obj.getMonth() - date1Obj.getMonth();

    const years = Math.floor(monthsDiff / 12);
    const months = monthsDiff % 12;

    startDate = formatMonthYear(date1);
    endDate = formatMonthYear(date2);

    if (years > 0) return `${startDate}-${flag ? "Present" : endDate}(${years}yrs ${months}months)`;
    else {
      return `${startDate}-${flag ? "Present" : endDate}(${months} months)`;
    }
  }
  ...
  const handleDelete = (e) => {
    ...
    if (activeSection === "exp") {
      const itemID = experienceDetails?._id;
      dispatch(deleteAssessorExperienceApi(setLoading, assessorMDBId, itemID, setOpenExp, getList, clearFormValues));
    } else if (activeSection === "edc") {
      const itemID = educationDetails?._id;
      dispatch(
        deleteAssessorEducationeApi(
          ...
          <div className="tab-wrapper">
            ...
            <div className="form">
              <div className="Certifications__tabpanel">
                <Box
                  ...
                  <Tabs
                    ...
                    {(getSchemeType(schemeType)?.includes("Non PMKVY") ||
                      ...
                      <Tab label="Previous Experience" {...a12yProps(0)} />
                    )}
                    {(getSchemeType(schemeType)?.includes("Non PMKVY") ||
                      getSchemeType(schemeType)?.includes("PMKVY")) && (
                      <Tab label="Educational Details" {...a12yProps(1)} />
                    )}
                    {(getSchemeType(schemeType)?.includes("Non PMKVY") ||
                      getSchemeType(schemeType)?.includes("PMKVY")) && <Tab label="Agreement" {...a12yProps(2)} />}
                    <Tab label="Job role Certificate" {...a12yProps(3)} />
                  </Tabs>
                </Box>
                <AssessorTabDegreePanel tabDegreeValue={tabDegreeValue} index={0}>
                      ...
                      <div key={index} className="Degree__contentBox">
                        <div className="Degree__contentBox_title">
                          ...
                          <div>
                            ...
                            <p>{dateDuration(item?.startDate, item?.endDate) || "-"}</p>
                            <a href={item?.url} target="location" className="file_link">
                              {item?.experienceCertificateName}
                            </a>
                          </div>
                        </div>
                        <div onClick={handleClickDialogOpen} className="edit__icon_box">
                          <Icon
                            className="edit__icon"
                            icon="fluent:edit-32-regular"
                            onClick={(e) => editDetailsHandler(e, item?._id, index, "exp")}></Icon>
                        </div>
                      </div>
                    ))
                  ) : (
                ...
                <AssessorTabDegreePanel tabDegreeValue={tabDegreeValue} index={1}>
                  <div className="Degree__tabBox">
                    <div className="Degree__title">
                      ...
                      <div key={index} className="Degree__contentBox">
                        ...
                        <div onClick={handleClickDialogOpen} className="edit__icon_box">
                          <Icon
                            className="edit__icon"
                            icon="fluent:edit-32-regular"
                            onClick={(e) => editDetailsHandler(e, item?._id, index)}></Icon>
                        </div>
                      </div>
                    ))
                  ) : (
                ...
                <AssessorTabDegreePanel tabDegreeValue={tabDegreeValue} index={2}>
                  <div className="Degree__tabBox">
                    <div className="Degree__title">
                      <h4>Agreement</h4>
                      <p>Edit or Update the Total Experience</p>
                      ...
                      <div key={index} className="Degree__contentBox">
                        <div className="Degree__contentBox_title">
                          ...
                          <div>
                            ...
                            {/* <h5>{item?.degree || "-"}</h5> */}
                            <p>
                              {`Valid from ${dateDuration(item?.agreementValidFrom, item?.agreementValidTo)}` || "-"}
                            </p>
                            <a href={item?.url} target="location" className="file_link">
                ...
                <AssessorTabDegreePanel tabDegreeValue={tabDegreeValue} index={3}>
                  <div className="Degree__tabBox">
                    <div className="Degree__title">
                      ...
                      <div key={index} className="Degree__contentBox">
                        <div className="Degree__contentBox_title">
                          ...
                          <div>
                            ...
                            <p>{`Valid from ${dateDuration(item?.issueDate, item?.validUpto)}` || "-"}</p>
                            <a href={item?.url} target="location" className="file_link">
      ...
      <Dialog
          ...
          <div className="form-wrapper" style={{ width: "100%" }}>
            <form>
              <div
                ...
                {activeSection === "exp" ? (
                  <>
                    <div style={{ width: "calc(100% - 10px)" }} className="form-group">
                      <Input
                        label="Designation"
                        name="designation"
                    ...
                    <div style={{ width: "calc(50% - 10px)" }} className="form-group">
                      <DateInput
                        ...
                        handleDateChange={(e) => dateChangeHandler(e, "startDate")}
                        mandatory
                        disableFuture
                    ...
                    <div style={{ width: "calc(50% - 10px)" }} className="form-group">
                      <DateInput
                        ...
                        handleDateChange={(e) => dateChangeHandler(e, "endDate")}
                        disableFuture
                        mandatory
                    ...
                    <div className="upload_files_container">
                      <div className="content_wrapper">
                        ...
                        <div className="controls_box">
                          <label htmlFor="exp">Click to upload <span style={{ color: "red" }}>*</span> </label>
                        </div>
                        {selectedFiles.length === 0 && experienceDetails?.experienceCertificateName && (
                  ...
                  <>
                    ...
                    <div className="upload_files_container">
                      <div className="content_wrapper">
                        ...
                        {selectedFiles.length === 0 && educationDetails?.educationCertificateName && (
                          <p style={{ fontSize: "10px" }}>
                    ...
                    <p className="error-input">{errors?.educationCertificate}</p>
                  </>
                ) : activeSection === "agr" ? (
                  <>
                    <div style={{ width: "calc(100% - 10px)" }} className="form-group">
                    ...
                    <div style={{ width: "calc(50% - 10px)" }} className="form-group">
                      <DateInput
                        ...
                        handleDateChange={(e) => dateChangeHandler(e, "agreementValidFrom")}
                        mandatory
                    ...
                    <div style={{ width: "calc(50% - 10px)" }} className="form-group">
                      <DateInput
                        ...
                        handleDateChange={(e) => dateChangeHandler(e, "agreementValidTo")}
                    ...
                    <div className="upload_files_container">
                      <div className="content_wrapper">
                        ...
                        {selectedFiles.length === 0 && agreementFormValues?.agreementCertificateName && (
                          <p style={{ fontSize: "10px" }}>
                    ...
                    <p className="error-input">{errors?.agreementCertificate}</p>
                  </>
                ) : (
                  <>
                    <div style={{ width: "calc(100% - 10px)" }} className="form-group">
                      <AutoCompleteAsyncInput
                        ...
                        setter={setJobRoleFormValues}
                        optionLists={ALPHABETIC_SORT(jobRoles)}
                    ...
                    <div style={{ width: "calc(50% - 10px)" }} className="form-group">
                      <DateInput
                        ...
                        handleDateChange={(e) => dateChangeHandler(e, "issueDate")}
                        mandatory
                    ...
                    <div style={{ width: "calc(50% - 10px)" }} className="form-group">
                      <DateInput
                        ...
                        onBlur={blurHandler}
                        error={errors?.endDate}
                        handleDateChange={(e) => dateChangeHandler(e, "validUpto")}
                    ...
                    <div className="upload_files_container">
                      <div className="content_wrapper">
                        ...
                        {selectedFiles.length === 0 && jobRoleFormValues?.jobRoleCertificateName && (
                          <p style={{ fontSize: "10px" }}>
        ...
        <DialogActions>
          <div className="actions_wrapper">
            <Button onClick={(e) => handleDelete(e)} sx={{ display: [isEditActive ? "" : "none"] }}>
              Delete
            </Button>
            <Button onClick={handleDialogClose} sx={{ display: [isEditActive ? "none" : ""] }}>
              Cancel
            </Button>
              ...
              <div {...getRootProps({ className: "dropzone" })}>
                ...
                <>
                  <div className="assign-batch-upload-item">
                    ...
                    <div>
                      <button className="btn btn-success upload-btn" disabled={!selectedFiles} onClick={upload}>
                        Click to upload
                      </button>
