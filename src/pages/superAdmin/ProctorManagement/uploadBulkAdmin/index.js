...
import {
  ...
  postAssessorBulkUploadAdminApi,
...
import {
  getSampleExcelProctorApi,
  postProctorBulkUploadAdminApi,
} from "../../../../api/superAdminApi/proctorManagement";

const UploadBulkAdmin = () => {
  ...
  const handleUploadFile = (event) => {
    ...
    data.append("bulkFile", file);

    setLoading(true);
    dispatch(
      postProctorBulkUploadAdminApi(data, setLoading, setFormValues, navigate)
    );
  };

  const downloadSampleFile = () => {
    dispatch(getSampleExcelProctorApi());
  };
...
export default UploadBulkAdmin;
